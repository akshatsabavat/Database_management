...
select distinct employees.employee_name, projects.project_name from employees left join employee_project on employees.employee_id = employee_project.employee_id left join projects on employee_project.project_id = projects.project_id;
